...
BEGIN_MESSAGE_MAP(CDialogEditObject, CDialog)
	//{{AFX_MSG_MAP(CDialogEditObject)
...
CDialogEditObject::CDialogEditObject(CWnd* pParent /*=NULL*/)
	: CDialog(CDialogEditObject::IDD, pParent)
{
...
CDialogEditObject::~CDialogEditObject()
{
}
...
BOOL CDialogEditObject::OnInitDialog() 
{	
...
//	pobjClassFolder->SetFlag(flagTemp, FALSE); // 1.1
...
void CDialogEditObject::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);

	//{{AFX_DATA_MAP(CDialogEditObject)
	...
	{
		// first make sure something is actually selected in the controls
		m_lvw.SelectAnything();
		m_cboDefaultClass.SelectAnything();
		m_cboLocation.SelectAnything();
...
int CDialogEditObject::DoModalAddObject(CString &strName, BObject* pobjParent, BObject* pobjClass, BObject* pobjDefaultClass)
{
	m_strName = strName;
...
int CDialogEditObject::DoModalEditObject(CString &strName, BObject* pobjParent, BObject *pobjClass, BObject *pobjDefaultClass)
{
	m_strName = strName;
	m_pobjParent = pobjParent;
	m_pobjClass = pobjClass;
...
void CDialogEditObject::OnChangeEditName() 
{
	// Set flag
	m_bNameChanged = TRUE;
}
...
void CDialogEditObject::OnNotifyItemChanged(NMHDR* pNMHDR, LRESULT* pResult) 
{
...
void CDialogEditObject::FillDefaultClassCombo()
{
...
// Class selection changed
void CDialogEditObject::OnClassChanged()
{
...
void CDialogEditObject::OnBtnHelp() 
{
...
void CDialogEditObject::OnDropdownCboLocation() 
{
...
void CDialogEditObject::OnSelchangeCboLocation() 
{
...
// Add a new class
void CDialogEditObject::OnBtnNewClass() 
{
...
// Add a new class
void CDialogEditObject::OnBtnNewClass2() 
{
	BObject* pobjNew = AddNewClass();
