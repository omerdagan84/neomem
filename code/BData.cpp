...
BOOL BData::EditValue(BObject* pobj, BObject* pobjPropertyDef)
{
...
BOOL BData::AddMenuItems(CMenu* pMenu, int nPos)
{
	// default: do nothing
	return FALSE;
}
...
BOOL BData::HandleCommand(UINT nCommandID)
{
	// default: do nothing
	return FALSE;
}
